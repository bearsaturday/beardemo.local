...
class App_Form_Wizard_Two extends App_Form_Wizard_One
{
    ...
    public function buildTwo()
    {
        ...
        $areaCode = HTML_QuickForm::createElement('text', '', null, ['size' => 3, 'maxlength' => 3]);
        $phoneNo1 = HTML_QuickForm::createElement('text', '', null, ['size' => 4, 'maxlength' => 4]);
        $phoneNo2 = HTML_QuickForm::createElement('text', '', null, ['size' => 4, 'maxlength' => 4]);
